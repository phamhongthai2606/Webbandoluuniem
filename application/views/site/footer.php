...
<!--<div class="row" id="footer" style="margin-top: 10px;padding-bottom: 60px;padding-top: 40px">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="padding-top: 10px">
            <address>
                <strong>    SHOP Quà Lưu Niệm</strong><br>
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: UTE - Cao Thắng - Đà Nẵng<br>
                <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: 0862698173<br>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="<?php echo base_url(); ?>" style="pointer-events: none;padding: 10px;background-color: white"><img src="<?php echo base_url(); ?>upload/logo.jpg" alt="" class="img-responsive"></a>
                    </div>
            ...
            <div class="col-lg-12 text-center">
                <div class="footer__copyright__text">
                    ...
                    <p>Copyright ©
                        ...
                        All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" >Phạm Hồng Thái</a>
                    </p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
