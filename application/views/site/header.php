        ...
        <div class="container-fluid re-container-fluid">
            ...
            <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url(); ?>" style="pointer-events: none"><img src="<?php echo base_url(); ?>upload/logo.jpg" alt="" class="img-responsive"></a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quà lưu niệm<span class="caret"></span></a>
